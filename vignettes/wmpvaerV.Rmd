...
This is a simple example of `statsBIf` using the plastic dataset. All that is needed for `statsBIf` to run is a matrix composed of numeric values and the definition of a variable idenfifying what columns are in the first block.
...
This is a more involved example using the wolf dataset. Again,all that is needed for `statsBIf` to run is a matrix composed of numeric values and the definition of a variable idenfifying what columns are in the first block. Since there are only 9 columns and p1 must be<=p2, 4 columns is the maximum size for block 1.
